...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){$(function(){$('.fl-node-55ea8d3ee007f .fl-gallery-item').wookmark({align:'center',autoResize:true,container:$('.fl-node-55ea8d3ee007f .fl-gallery'),offset:10,itemWidth:150});$('.fl-node-55ea8d3ee007f .fl-mosaicflow-content, .fl-node-55ea8d3ee007f .fl-gallery').magnificPopup({closeBtnInside:false,delegate:'.fl-photo-content a',type:'image',gallery:{enabled:true}});});})(jQuery);(function($){$('.fl-node-55dd454cc9fbc .fl-slider-next').empty();$('.fl-node-55dd454cc9fbc .fl-slider-prev').empty();$('.fl-node-55dd454cc9fbc .fl-testimonials').bxSlider({autoStart:1,auto:true,adaptiveHeight:true,pause:10000,mode:'fade',speed:1000,pager:1,nextSelector:'.fl-node-55dd454cc9fbc .fl-slider-next',prevSelector:'.fl-node-55dd454cc9fbc .fl-slider-prev',nextText:'<i class="fa fa-chevron-circle-right"></i>',prevText:'<i class="fa fa-chevron-circle-left"></i>',controls:0,onSliderLoad:function(){$('.fl-node-55dd454cc9fbc .fl-testimonials').addClass('fl-testimonials-loaded');}});})(jQuery);var wpAjaxUrl='http://www.dogtraining.dev/wp-admin/admin-ajax.php';var flBuilderUrl='http://www.dogtraining.dev/wp-content/plugins/bb-plugin/';